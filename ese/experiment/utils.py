...
def show_inference_examples(
    ...
    pred_threshold = inference_cfg['experiment']['pred_threshold']
    ...
    if show_first_pred:
        ShowPredictionsCallback(show_dict, threshold=pred_threshold)
    ...
    if inference_cfg["model"].get("ensemble", False):
        ...
        ShowPredictionsCallback(ensembled_output_dict, threshold=pred_threshold)
