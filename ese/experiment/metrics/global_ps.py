...
def global_bin_stats(
    ...
    for prob_bin in accumulated_meters_dict.keys():
        ...
        bin_conf = accumulated_meters_dict[prob_bin]["confidence"].mean
        bin_acc = accumulated_meters_dict[prob_bin]["accuracy"].mean
        num_samples = accumulated_meters_dict[prob_bin]["accuracy"].n
...
def global_top_label_bin_stats(
    ...
    unique_labels = unique_values_dict["pred_label"]
    unique_bins = unique_values_dict["prob_bin"]
    # Get the num bins.
    ...
    for label in accumulated_meters_dict.keys():
        for prob_bin in accumulated_meters_dict[label].keys():
            # Choose what key to use.
            bin_conf = accumulated_meters_dict[label][prob_bin]["confidence"].mean
            bin_acc = accumulated_meters_dict[label][prob_bin]["accuracy"].mean
            num_samples = accumulated_meters_dict[label][prob_bin]["accuracy"].n
            # Calculate the average calibration error for the regions in the bin.
...
def global_neighbor_bin_stats(
    ...
    for neighbor_class in accumulated_meters_dict.keys():
        for prob_bin in accumulated_meters_dict[neighbor_class].keys():
            # Choose what key to use.
            bin_conf = accumulated_meters_dict[neighbor_class][prob_bin]["confidence"].mean
            bin_acc = accumulated_meters_dict[neighbor_class][prob_bin]["accuracy"].mean
            num_samples = accumulated_meters_dict[neighbor_class][prob_bin]["accuracy"].n
            # Calculate the average calibration error for the regions in the bin.
